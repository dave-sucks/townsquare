        ...
        {place.photoRefs && (place.photoRefs as string[]).length > 0 ? (
          <div className="w-full aspect-[16/9] max-h-[300px] bg-muted relative overflow-hidden rounded-lg mb-4 group">
            ...
            {locationDisplay && (
              ...
              >
                <Badge variant="secondary" className="flex items-center gap-1.5 py-1 px-2.5 cursor-pointer bg-background/80 backdrop-blur-sm border-none hover:bg-background">
                  ...
                  <span className="text-foreground font-medium">{locationDisplay}</span>
                </Badge>
              </a>
            )}
          </div>
