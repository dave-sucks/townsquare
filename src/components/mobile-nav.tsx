...
export function MobileNav({ user }: { user: User | null }) {
  ...
  return (
    <>
      {menuOpen && (
        <div
          className="fixed inset-0 z-[44] bg-background/70 backdrop-blur-xl md:hidden"
      ...
      <div
        className="fixed bottom-0 left-0 right-0 z-[45] md:hidden border-t border-border/40 bg-background/80 backdrop-blur-2xl pb-[env(safe-area-inset-bottom,0px)]"
