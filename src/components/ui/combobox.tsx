...
import { Tick01Icon, ArrowDown01Icon, Cancel01Icon } from "@hugeicons/core-free-icons"
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <HugeiconsIcon icon={Tick01Icon} className="pointer-events-none size-4 pointer-coarse:size-5" />
      </ComboboxPrimitive.ItemIndicator>
    </ComboboxPrimitive.Item>
  )
}
